...
public class MindustryOptiFine extends Mod{
    ...
    TextureRegion get(String name){
        return Core.atlas.find(name + "-mindustry-optifine", Core.atlas.find("mindustry-optifine-" + name));
    }

    TextureRegion getReplace(String name){
        return Core.atlas.find(name + "-mindustry-optifine-replace", Core.atlas.find("mindustry-optifine-" + name + "-replace"));
    }

    Seq<TextureRegion> getHeat(String name){
        tmpRegions.clear();
        TextureRegion right = find(name + "-mindustry-optifine-heat", name + "-mindustry-optifine-heat-r", "mindustry-optifine-" + name + "-heat", "mindustry-optifine-" + name + "-r-heat");
        TextureRegion left = find(name + "-mindustry-optifine-heat-l", "mindustry-optifine-" + name + "-l-heat");
